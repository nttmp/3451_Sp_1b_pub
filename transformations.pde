...
//    }
//  }
//  Matrix C = copyMatrix(B);
//  println("A\n" + A.print());
//  println("B\n" + B.print());
// 
//  println("C (checkking copy)\n" + C.print());
//  transposeMatrix(C);
// println("C after transpose\n" + C.print());
//  
//  //For testing matrix stack
//  //Initialize
//  gtInitialize();
//  printMatrixStack();
//  //PushMatrix
...
//  
  //Dot Product
//  Vector v1 = new Vector(2.0,3.0,2.0);
//  Vector v2 = new Vector(4.0,5.0,6.0);
//  println(v1.dotProduct(v2));
//  //Cross Product
//  Vector v3 = v1.crossProduct(v2);
//  println(v3.print());
//  Vector v4 = new Vector(3.0, -3.0, 1.0);
//  Vector v5 = new Vector(4.0, 9.0, 2.0);
//  Vector v6 = v4.crossProduct(v5);
//  println(v6.print());
//  //Matrix vector multiplication
//  Vector v7 = matrixVectorMult(matrixStack.get(matrixStack.size()-1), v5);
//  println(v7.print());
//  //Magnitude
